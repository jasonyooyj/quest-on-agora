      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        >
          <div className="p-6 border-b border-zinc-200 flex items-center justify-between">
            <div>
              <h2 className="text-lg font-bold text-zinc-900">최근 가입 사용자</h2>
              <p className="text-sm text-zinc-500">최근 5명의 신규 가입자</p>
            </div>
            <Link
              href="/admin/users"
                ...
                >
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <span className="text-xs text-zinc-400">
                      {format(new Date(user.created_at), 'MM.dd', { locale: ko })}
                    </span>
                  </div>
                </Link>
              ))
        ...
        >
          <div className="p-6 border-b border-zinc-200 flex items-center justify-between">
            <div>
              <h2 className="text-lg font-bold text-zinc-900">최근 생성 토론</h2>
              <p className="text-sm text-zinc-500">최근 5개의 토론 세션</p>
            </div>
            <Link
