      ...
      <main className="max-w-7xl mx-auto px-6 lg:px-12 py-12 relative z-10">
          ...
          <div className="glass-panel p-1 border-zinc-200 bg-white/90 shadow-sm">
            <div className="p-8 md:p-10 flex flex-col lg:flex-row lg:items-center gap-10">
              <div className="flex-1">
                <h2 className="text-2xl font-bold text-zinc-900 mb-3">토론 참여하기</h2>
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <div className="relative group">
                  ...
                  <input
                    ...
                    className="ios-input pl-14 h-16 w-full sm:w-64 text-2xl font-bold tracking-[0.2em] placeholder:text-zinc-400 placeholder:tracking-normal placeholder:font-normal"
                    maxLength={6}
                  />
                </div>
                <button
                  ...
                  disabled={isJoining}
                  className="group relative h-16 bg-gradient-to-r from-indigo-500 to-purple-600 text-white font-extrabold rounded-full px-10 transition-all hover:shadow-[0_4px_20px_rgba(99,102,241,0.4)] hover:-translate-y-1 active:scale-95 disabled:opacity-50"
                >
        ...
        >
          <div className="flex items-end justify-between mb-8 px-2">
            <div>
              <h2 className="text-3xl font-bold text-zinc-900 mb-1">내 토론 리스트</h2>
          ...
          {discussions.length === 0 ? (
            <div className="glass-panel bg-white/90 border-zinc-200 p-20 text-center shadow-sm">
              ...
              <h3 className="text-2xl font-bold text-zinc-900 mb-3">참여한 토론이 없습니다</h3>
