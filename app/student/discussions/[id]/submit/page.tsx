    ...
    useEffect(() => {
        ...
        const fetchKeyPoints = async () => {
            ...
            try {
                ...
                setKeyPoints(['대화의 핵심 포인트를 불러올 수 없습니다.'])
            } finally {
                ...
                >
                    <div className="px-6 py-4 border-b border-zinc-100 flex items-center gap-3">
                        ...
                        <div className="flex-1">
                            <h2 className="font-bold text-zinc-900">나의 최종 정리</h2>
                            <p className="text-xs text-zinc-500">오늘 토론을 통해 느낀 점이나 생각을 자유롭게 정리해보세요 (선택)</p>
                        </div>
                    ...
                    <div className="p-6">
                        <textarea
                            ...
                            placeholder="예: 처음에는 A라고 생각했는데, 토론을 통해 B 관점도 고려하게 되었습니다..."
