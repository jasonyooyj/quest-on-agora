...
export default function InstructorDiscussionPage() {
    ...
    const formatReportText = (report: {
        ...
        const stanceDistStr = Object.entries(report.statistics.stanceDistribution)
            .map(([k, v]) => `${t(`participants.stance.${k}`, { default: k })}: ${v}명`)
            .join(', ')
            ...
            <div className="bg-zinc-50 border-b border-zinc-200 backdrop-blur-sm relative z-40">
                <div className="max-w-[1920px] w-full mx-auto px-10 py-4 flex items-center gap-8">
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            <p className="text-[10px] font-extrabold text-zinc-500 uppercase tracking-widest">{t('stats.participants')}</p>
                    ...
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            <p className="text-[10px] font-extrabold text-zinc-500 uppercase tracking-widest">{t('stats.submissions')}</p>
                    ...
                    {needsHelpCount > 0 && (
                        <>
                            ...
                            <div className="flex items-center gap-4 animate-pulse">
                                ...
                                <div>
                                    <p className="text-[10px] font-extrabold text-amber-600 uppercase tracking-widest">{t('stats.helpRequests')}</p>
                    ...
                    {extensionCount > 0 && (
                        <>
                            ...
                            <div className="flex items-center gap-4">
                                ...
                                <div>
                                    <p className="text-[10px] font-extrabold text-orange-600 uppercase tracking-widest">{t('stats.extensionRequests')}</p>
                                ...
                                <div className="grid grid-cols-2 gap-4">
                                    <div className="bg-zinc-50 rounded-2xl p-4 border border-zinc-200">
                                        ...
                                        <p className="font-bold text-zinc-900 uppercase text-xs">
                                            {discussion.settings.aiMode === 'socratic' ? t('NewDiscussion.phases.aiTutor.modes.socratic.label') :
                                                discussion.settings.aiMode === 'debate' ? t('NewDiscussion.phases.aiTutor.modes.debate.label') : t('NewDiscussion.phases.aiTutor.modes.balanced.label')}
                                        </p>
                                    </div>
                                    <div className="bg-zinc-50 rounded-2xl p-4 border border-zinc-200">
