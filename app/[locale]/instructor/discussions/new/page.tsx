        ...
        >
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-12">
              ...
              <div className="space-y-10">
                ...
                {showTopicGenerator && (
                  <div className="flex items-center gap-4 py-2">
                    ...
                    <span className="text-[10px] font-bold text-zinc-400 uppercase tracking-widest">or manual input</span>
                    <div className="flex-1 h-px bg-zinc-200" />
                  </div>
                )}

                <div className="space-y-4">
                  <label className="text-sm font-black text-zinc-500 uppercase tracking-widest block px-1">Discussion Topic <span className="text-primary">*</span></label>
                ...
                <div className="space-y-4">
                  <label className="text-sm font-black text-zinc-500 uppercase tracking-widest block px-1">Description (Optional)</label>
                  <textarea
                    placeholder="Provide context, key questions, or background information..."
                ...
                <div className={`p-8 rounded-[3rem] bg-zinc-50 border border-zinc-200 transition-all ${useCustomStances ? 'border-primary/30 bg-primary/5' : 'hover:bg-zinc-100'}`}>
                  <div className="flex items-center justify-between mb-8">
                    <div className="flex items-center gap-6">
                      ...
                      <div>
                        <p className="text-lg font-black text-zinc-900">{t('phases.environment.stances.title')}</p>
                        <p className="text-sm text-zinc-500 font-medium">{t('phases.environment.stances.desc')}</p>
                      </div>
                    </div>
                    <Switch
                ...
                <div className="p-10 rounded-[3.5rem] bg-zinc-50 border border-zinc-200 relative overflow-hidden">
                  ...
                  <div className="grid grid-cols-2 gap-6 relative z-10">
                    <div className="p-8 rounded-[2.5rem] bg-white/80 border border-zinc-200 backdrop-blur-md relative group/stat overflow-hidden shadow-sm">
                      ...
                      <span className="text-[10px] font-black text-zinc-500 tracking-[0.2em] uppercase block mb-2">{t('phases.environment.duration.stat')}</span>
                    ...
                    <div className="p-8 rounded-[2.5rem] bg-white/80 border border-zinc-200 backdrop-blur-md relative group/stat overflow-hidden shadow-sm">
                      ...
                      <span className="text-[10px] font-black text-zinc-500 tracking-[0.2em] uppercase block mb-2">{t('phases.environment.duration.precision')}</span>
                      <div className="text-4xl font-black text-zinc-900 flex items-baseline gap-2">
            ...
            <div className="p-8 rounded-[3rem] bg-primary/5 border border-primary/20 flex items-start gap-8 group">
              ...
              <div>
                <p className="text-lg font-black text-zinc-900">{t('guideline.title')}</p>
                <p className="text-sm text-zinc-600 leading-relaxed mt-2 font-medium">
                  {t.rich('guideline.desc', {
