  ...
  const getStatusBadge = (status: string) => {
    ...
    return (
      <span className={`px-2 py-0.5 rounded-full text-[10px] font-bold border ${styles[status as keyof typeof styles]}`}>
        {t(`recentDiscussions.status.${status}`)}
      </span>
    )
  }
    ...
    <div className="p-6 lg:p-8 max-w-7xl">
      ...
      >
        <div className="glass-panel bg-white p-6 border-zinc-200 hover:border-zinc-300 transition-all group">
          ...
          <p className="text-[10px] font-bold text-zinc-500 uppercase tracking-widest">{t('stats.totalUsers')}</p>
        </div>
        ...
        <div className="glass-panel bg-white p-6 border-zinc-200 hover:border-zinc-300 transition-all group">
          ...
          <p className="text-[10px] font-bold text-zinc-500 uppercase tracking-widest">{t('stats.instructors')}</p>
        </div>
        ...
        <div className="glass-panel bg-white p-6 border-zinc-200 hover:border-zinc-300 transition-all group">
          ...
          <p className="text-[10px] font-bold text-zinc-500 uppercase tracking-widest">{t('stats.students')}</p>
        </div>
        ...
        <div className="glass-panel bg-white p-6 border-zinc-200 hover:border-zinc-300 transition-all group">
          ...
          <p className="text-[10px] font-bold text-zinc-500 uppercase tracking-widest">{t('stats.todaySignups')}</p>
        </div>
      </motion.div>
      ...
      >
        <div className="glass-panel bg-white p-6 border-zinc-200 hover:border-zinc-300 transition-all group">
          ...
          <p className="text-[10px] font-bold text-zinc-500 uppercase tracking-widest">{t('stats.totalDiscussions')}</p>
        </div>
        ...
        <div className="glass-panel bg-white p-6 border-zinc-200 hover:border-zinc-300 transition-all group">
          ...
          <p className="text-[10px] font-bold text-zinc-500 uppercase tracking-widest">{t('stats.activeDiscussions')}</p>
        </div>
        ...
        <div className="glass-panel bg-white p-6 border-zinc-200 hover:border-zinc-300 transition-all group">
          ...
          <p className="text-[10px] font-bold text-zinc-500 uppercase tracking-widest">{t('stats.closedDiscussions')}</p>
        </div>
        ...
        <div className="glass-panel bg-white p-6 border-zinc-200 hover:border-zinc-300 transition-all group">
          ...
          <p className="text-[10px] font-bold text-zinc-500 uppercase tracking-widest">{t('stats.weekSignups')}</p>
        </div>
      </motion.div>
