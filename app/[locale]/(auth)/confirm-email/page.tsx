...
export default function ConfirmEmailPage() {
    ...
    }, [email, cooldown, isResending, t, tErr])
            ...
            >
                ...
                <div className="space-y-4 mb-8">
                    <div className="flex items-center gap-4 p-4 rounded-xl bg-zinc-50 border border-zinc-100">
                        ...
                        <div className="flex-1">
                            <div className="flex items-center gap-2">
                                <span className="text-xs font-bold text-indigo-600">{t('step1')}</span>
                            </div>
                            <p className="text-sm text-zinc-700 font-medium">{t('step1Desc')}</p>
                        </div>
                    </div>
                    ...
                    <div className="flex items-center gap-4 p-4 rounded-xl bg-zinc-50 border border-zinc-100">
                        ...
                        <div className="flex-1">
                            <div className="flex items-center gap-2">
                                <span className="text-xs font-bold text-purple-600">{t('step2')}</span>
                            </div>
                            <p className="text-sm text-zinc-700 font-medium">{t('step2Desc')}</p>
                        </div>
                    </div>
                    ...
                    <div className="flex items-center gap-4 p-4 rounded-xl bg-zinc-50 border border-zinc-100">
                        ...
                        <div className="flex-1">
                            <div className="flex items-center gap-2">
                                <span className="text-xs font-bold text-green-600">{t('step3')}</span>
                            </div>
                            <p className="text-sm text-zinc-700 font-medium">{t('step3Desc')}</p>
                        </div>
                    </div>
                </div>
                    ...
                    <div className="mb-6">
                        ...
                        >
                            {isResending ? (
                                ...
                                <span className="text-xs text-zinc-300">{t('cooldown', { seconds: cooldown })}</span>
                            ) : (
                                <>
                ...
                <div className="text-center text-sm text-zinc-500 mb-8 p-3 rounded-lg bg-amber-50 border border-amber-100">
                    <span className="text-amber-600">{t('spamTipTitle')}</span>{' '}
                    {t('spamTip')}
                </div>
