                ...
                <div className="max-w-4xl mx-auto px-4 py-4 flex items-center justify-between">
                    <div className="flex items-center gap-3 sm:gap-4 min-w-0 flex-1">
                        <Link
                            ...
                            className="p-2.5 rounded-full hover:bg-black/5 transition-colors shrink-0"
                        >
                            <ArrowLeft className="w-5 h-5 text-muted-foreground" />
                        </Link>
                        <div className="min-w-0 flex-1">
                            <h1 className="font-semibold text-lg sm:text-xl tracking-tight text-foreground/90 truncate">
                                {t('header.title')}
                            </h1>
                            <p className="text-sm text-muted-foreground/80 font-medium truncate">{discussion.title}</p>
                        </div>
                    </div>
