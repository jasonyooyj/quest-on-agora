      ...
      <main className="max-w-7xl mx-auto px-6 lg:px-12 py-12 relative z-10">
        ...
        >
          <div className="glass-panel p-8 bg-white/90 border-zinc-200 hover:border-zinc-300 transition-all group shadow-sm">
            ...
            <p className="text-[10px] font-extrabold text-zinc-500 uppercase tracking-widest">{t('stats.total')}</p>
          </div>
          ...
          <div className="glass-panel p-8 bg-white/90 border-zinc-200 hover:border-zinc-300 transition-all group shadow-sm">
            ...
            <p className="text-[10px] font-extrabold text-zinc-500 uppercase tracking-widest">{t('stats.active')}</p>
          </div>
