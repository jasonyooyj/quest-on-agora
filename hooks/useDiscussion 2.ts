...
const normalizeSession = (raw: RawRecord): DiscussionSession => ({
  id: raw.id,
...
const normalizeParticipant = (raw: RawRecord): DiscussionParticipant => {
  if ("sessionId" in raw) {
...
const normalizeMessage = (raw: RawRecord): DiscussionMessage => {
  if ("sessionId" in raw) {
