...
export const AI_MODES = [
    {
        ...
        title: "질문으로 이끄는 사고",
        description:
            "AI가 '왜 그렇게 생각하나요?', '다른 관점에서 보면?'과 같은 탐구 질문을 던집니다. 직접적인 답을 주지 않고, 학생이 스스로 생각의 모순을 발견하도록 유도합니다.",
        example: {
            student: "환경보호를 위해 모든 플라스틱 사용을 금지해야 합니다.",
            ai: "그렇다면 플라스틱 없이 의료 기기나 안전 장비는 어떻게 만들 수 있을까요? 완전 금지와 규제 강화 사이에는 어떤 차이가 있을까요?",
        },
        color: "sage" as const,
    },
    {
